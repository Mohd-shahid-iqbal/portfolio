export const personalInfo = {
  ...
  tagline: "Crafting high-performance trading platforms & enterprise web experiences",
...
export const stats = [
  { value: "5+", label: "Years Experience", description: "Building production apps" },
  { value: "6K+", label: "Stocks Streamed", description: "Live concurrent WebSocket feeds" },
  { value: "60%", label: "Reusability Boost", description: "Via Storybook component system" },
  { value: "50%", label: "UI Lag Reduced", description: "React memoization & optimization" },
];
...
export const skillCategories = [
  ...
  },
  {
    ...
    icon: "layout",
    skills: ["React", "Next.js", "Micro Frontends", "Storybook", "React Native"],
  },
  {
    id: "backend",
    label: "Backend",
  ...
  },
  {
    ...
    icon: "palette",
    skills: ["Tailwind CSS", "Chakra UI", "Material UI (MUI)", "Styled Components"],
  },
  {
    id: "devops",
    label: "DevOps & Tools",
...
export const experience = [
  {
    ...
    tech: ["React", "TypeScript", "Tailwind CSS", "Chakra UI", "WebSockets", "Storybook", "MFE", "CI/CD"],
  },
  {
    id: "vendify",
...
export const projects = [
  {
    ...
    tech: ["React", "TypeScript", "WebSockets", "Tailwind CSS", "Chakra UI", "MFE", "Storybook"],
    color: "indigo",
  ...
  },
  {
    ...
    tech: ["Module Federation", "React", "Webpack", "CI/CD", "Docker", "Jenkins"],
    color: "violet",
  ...
  },
  {
    ...
    tech: ["Storybook", "React", "Tailwind CSS", "TypeScript", "Chromatic", "A11y"],
    color: "cyan",
  ...
  },
  {
    ...
    tech: ["React 19", "Tailwind v4", "Puppeteer", "Express", "PDF.js", "Mammoth", "Vite"],
    color: "cyan",
