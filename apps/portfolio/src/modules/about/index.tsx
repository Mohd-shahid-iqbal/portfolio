            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  background:
                    "radial-gradient(circle, rgba(99,102,241,0.25) 0%, rgba(167,139,250,0.1) 50%, transparent 100%)",
                }}
              />
              ...
              >
                {ORBIT_TECHS.map((tech, i) => {
                  const angle =
                    ((360 / ORBIT_TECHS.length) * i - 90) * (Math.PI / 180);
